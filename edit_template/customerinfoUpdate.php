...
$sqlr = "SELECT * FROM tb_customer WHERE c_id = '$fID'";
...
<body>
    ...
    <div class="container-fluid pt-4 px-4">
        <form method="POST" action="customerinfoUpdateProcess.php">
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Modify Customer Details</h6>
                    <!-- <div class="form-floating mb-3"> -->
                    <div class="form-group">
                        <?php
                        echo '<input type="hidden" value="' . $rowr['c_id'] . '" name="fID" class="form-control" id="exampleInputPassword1" required>';
                        ?>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="form-label mt-4">Customer Name</label>
                        <?php
                        echo '<input type="text" value="' . $rowr['c_name'] . '" name="fname" class="form-control" id="exampleInputPassword1" required>';
                        ?>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1" class="form-label mt-4">Customer Email</label>
                        <?php
                        echo '<input type="text" value="' . $rowr['c_email'] . '" name="femail" class="form-control" id="exampleInputPassword1" required>';
                        ?>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="form-label mt-4">Customer Phone</label>
                        <?php
                        echo '<input type="text" value="' . $rowr['c_phone'] . '" name="fphone" class="form-control" id="exampleInputPassword1" required>';
                        ?>
                    </div>
                    <br>
