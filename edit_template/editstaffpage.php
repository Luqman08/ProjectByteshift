    ...
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="manageorder.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
    ...
    <div class="container-fluid pt-4 px-4">
        <form method="POST" action="editstaffprocess.php">
            ...
            <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4">Modify Staff Details</h6>
                <!-- <div class="form-floating mb-3"> -->

                <?php
                echo '<input type="hidden" value="' . $rowr['u_id'] . '" name="fID" class="form-control" id="exampleInputPassword1" required>';
                ?>
                ...
                <button class="btn btn-primary m-2" type="submit">Modify</button>
                <button class="btn btn-outline-primary m-2" type="reset">Reset</button>
            </div>
    </div>
    </form>
