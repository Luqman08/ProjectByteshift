        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary rounded h-100 p-4">
                <fieldset>
                    ...
                    <?php
                    echo '<input type="hidden" value="' . $rowr["cp_state"] . '" name="istate" class="form-control" id="floatingInput">'
                    ?>

                    <?php
                    echo '<input type="hidden" value="' . $rowr["cp_city"] . '" name="icity" class="form-control" id="floatingInput">'
                    ?>

                    <?php
                    echo '<input type="hidden" value="' . $rowr["cp_distance"] . '" name="idistance" class="form-control" id="floatingInput">'
                    ?>
