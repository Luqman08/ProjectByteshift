...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "Debugging: itemName=$itemName, itemType=$itemType, itemCategory=$itemCategory<br>";
    ...
    if ($stmt) {
        ...
        // Debugging: Print SQL query, result, and affected rows
        echo "Debugging: SQL Query=$sql<br>";
        echo "Debugging: Result=$result, Affected Rows=" . mysqli_stmt_affected_rows($stmt) . "<br>";
